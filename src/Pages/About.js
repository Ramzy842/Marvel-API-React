...
const About = () => {
  ...
  return (
    <div className="about">
      ...
      <p>Under the hood, Marvomics uses The Marvel API to search for the characters as well as the comics</p>
      <h2><GrTechnology className="techs-logo" />Technologies used:</h2>
