      ...
      <div className="home">
        <div className="hero">
          <section>
            ...
            <div className="btns">
              <Link to="/characters" className="hero-link">Characters</Link>
              <Link to="/comics" className="hero-link" >Comics</Link>
              <a href="#categories" className="hero-link">View Categories</a>
            </div>
          </section>
        </div>
            ...
            return (
              <div key={index} className="mcu-avengers">
                ...
                <div className="mcu-avengers-content">
                  <img src={image} style={{boxShadow: `0px 2px 8px ${color}`}} alt={title} />
                  <Link to={path}  onMouseOver={(e) => handleMouseOver(e, color)} onMouseOut={(e) => handleMouseOut(e)} className="avengers-link">
                    View More
                  </Link>
                </div>
              </div>
